...
class StampDutyCalculatorPlugin extends BasePlugin
{
    /**
    ...
    {
         return Craft::t('Stamp Duty Calculator');
    }
    ...
    {
        return Craft::t('Calculates UK Stamp Duty');
    }
